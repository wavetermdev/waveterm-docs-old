...
Wave AI comes with default settings that work out of the box. However, you can customize your experience by modifying the following settings in the UI, or by using the [/client:set](/reference/slashcommands#client-set) command.

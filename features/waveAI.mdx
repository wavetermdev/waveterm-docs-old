...
- `openaiapitoken`: Change this setting if you prefer to use your own OpenAI API key. You can also use this setting in conjunction with `openaibaseurl` to configure a different service altogether.
